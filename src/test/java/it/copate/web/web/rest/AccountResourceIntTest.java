package it.copate.web.web.rest;

import it.copate.web.Casoin2App;
import it.copate.web.config.Constants;
import it.copate.web.domain.Authority;
import it.copate.web.domain.PersistentToken;
import it.copate.web.domain.User;
import it.copate.web.repository.AuthorityRepository;
import it.copate.web.repository.PersistentTokenRepository;
import it.copate.web.repository.UserRepository;
import it.copate.web.security.AuthoritiesConstants;
import it.copate.web.service.MailService;
import it.copate.web.service.UserService;
import it.copate.web.service.dto.PasswordChangeDTO;
import it.copate.web.service.dto.UserDTO;
import it.copate.web.web.rest.errors.ExceptionTranslator;
import it.copate.web.web.rest.vm.KeyAndPasswordVM;
import it.copate.web.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = Casoin2App.class)
